...
urlpatterns = [
    #Measure Unit CRUD
    path('measureUnit/', gv.MeasureUnitListApiView.as_view(), name='measure_unit_api'),
    ...
    path('categoryProduct/', gv.CategoryProductListApiView.as_view(), name='category_product_api'),
    ...
    #Indicator CRUD
    path('indicator/', gv.IndicatorListApiView.as_view(), name='indicator_api'),
